class DartFromSource < Formula
  desc "The Dart SDK"
  homepage "https://www.dartlang.org/"
  conflicts_with "dart-sdk/dart/dart", :because => "They install the same program"
  url "https://github.com/dart-lang/sdk/archive/1.24.3.tar.gz"
  devel "https://github.com/dart-lang/sdk/archive/2.0.0-dev.54.0.tar.gz"
